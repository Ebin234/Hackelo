      ...
      <nav className="h-[86px] flex items-center justify-between pl-5 pr-5">
        <div className="flex flex-row gap-8 items-center">
          ...
          <Link
            ...
            className={`text-[16px] font-normal ${active === "Discover" ? "text-[#CC97FF] border-b-2" : "text-[#DEE5FF]"}  `}
          >
            Discover
          </Link>
          <Link
            ...
            className={`text-[16px] font-normal ${active === "Teams" ? "text-[#CC97FF] border-b-2" : "text-[#DEE5FF]"}  `}
          >
            Teams
          </Link>
          <Link
            ...
            className={`text-[16px] font-normal ${active === "Hackathons" ? "text-[#CC97FF] border-b-2" : "text-[#DEE5FF]"}  `}
          >
            Hackathons
          </Link>
        </div>
